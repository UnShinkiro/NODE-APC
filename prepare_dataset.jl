    ...
    for sub_folder in sub_folders
        ...
        for file in files
            ...
            elseif file_count == batch_size
                ...
                global all_mels = []
                global all_mels = log_mel
                global batch_count += 1
                global file_count = 1
            else
                global all_mels = cat(all_mels, log_mel, dims=3)
                #append!(lengths, length)
                global file_count += 1 
            end
        end
...
for batch = 0:batch_count
    global batch_file_list = cat(batch_file_list, "batch_$batch.jld", dims=1)
end
